...
# 	if min%5 ==0
		...
		res = Net::HTTP.post_form(uri, 'message' => message, 'access_token' => 'CAACEdEose0cBACgsHaAHeQMW6vvr5kBbbZB5bIGqRAJwUYi4j1NmscovqY453EaZBVfZBZAATwMbKXxjkRNYP1SfHe77W95hW9YFOWBYOK8xtZCUCC7YHAavEZBmZAUvfcPWrZAsGAUsB3kRtx2ZBzkgMzmrDjwXoxjv3LfLycGn0WXSMlQx2PJS3oDBhcsSaWZCoZD')
		puts res.body
# 	else
# 		sleep 30
# 	end
